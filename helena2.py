...
print('\nA long time ago in a galaxy far, far away... '
      ...
      '\nIn some rounds, you must use the Force to choose the starship’s strongest characteristic, '
      'which will be compared to the Galactic Empire’s allocated card.'
      ...
      '\nYour score will be recorded. You win 2 points for defeating the Empire, '
      '1 point for a draw and 0 points for losing. '
...
def run():
    ...
    allocation_choice = input(
        '\nRound {}: Would you like to choose your card or be allocated a random one? '
        'Type C to choose or R for random. '.format(run.counter))
    ...
    if allocation_choice == 'C':
        chosen_ship = input("\nYou have a choice between Starship 1: '{}' or Starship 2: '{}'. "
                            "Please type 1 or 2 to make your choice. ".format(choice_1['name'], choice_2['name']))
        if chosen_ship == '1':
            my_ship = choice_1
        elif chosen_ship == '2':
            my_ship = choice_2
        ...
        def battle_cards():
            ...
            if my_statistic > empire_statistic:
                ...
                print("\nYou have been defeated by the Empire."
                      "\nYour score remains {}. "
                      "\nBut do not lose hope, young Jedi. "
                      "Your time will come to restore peace to the Galaxy. ".format(len(score_list)))
            else:
                score_list.append('1')
            ...
            if len(score_list) >= 10:
                print(
                    "\nCongratulations, young Jedi. You have helped the Rebellion to defeat the Galactic Empire. "
                    "Peace and freedom can now be restored to the Galaxy.")
