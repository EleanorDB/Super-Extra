...
def run():
    ...
    while(game_running):
        round_number += 1
        allocation_choice = input('\nRound {}: Would you like to choose your card or be allocated a random one? Type C to choose or R for random. '.format(round_number))
            ...
            #turning API results for user & Empire into integers
                ...
                if my_stat_int > emp_stat_int:
                    ...
                    print("\nYou have been defeated by the Empire."
                          "\nYour score remains {}. "
                          "\nBut do not lose hope, young Jedi. Your time will come to restore peace to the Galaxy. ".format(total_score))
